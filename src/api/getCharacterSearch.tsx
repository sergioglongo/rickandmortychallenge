...
export const getCharacterSearch = (name: string, status: string | null) => {
    ...
    const loadCharacters = async () => {
        ...
        try {
            const characters = await axios.get<CharactersPaginatedResponse>(`https://rickandmortyapi.com/api/character/?name=${name}&status=${status}`)
            .then(async resp=>{
